...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-surface-primary">
      {/* Mobile header */}
      <div className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between bg-surface-secondary/80 backdrop-blur-xl border-b border-border-primary px-4 h-14 md:hidden">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-base font-semibold text-text-primary">Goal Tracker</h1>
        </div>
        <button
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-surface-secondary border-r border-border-primary flex flex-col transform transition-transform duration-200 ease-in-out md:static md:translate-x-0 ${
